...
def show_hot_menu():
    ...
    while in_hot_menu:
        ...
        try:
            ...
            print_panel("Error", "Gagal mengambil data HOT Package.")
            pause()
            return
        ...
        if choice.isdigit() and 1 <= int(choice) <= len(hot_packages):
            ...
            print_panel("Error", "Input tidak valid. Silakan masukkan nomor yang tersedia.")
            pause()
...
def show_hot_menu2():
    ...
    while in_hot_menu:
        ...
        if choice.isdigit() and 1 <= int(choice) <= len(hot_packages):
            ...
            if not packages:
                print_panel("Error", "Paket tidak tersedia.")
                pause()
                continue
